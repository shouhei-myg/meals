# -*- encoding: utf-8 -*-
# stub: cfn-status 0.4.6 ruby lib

Gem::Specification.new do |s|
  s.name = "cfn-status".freeze
  s.version = "0.4.6"
  ...
  s.homepage = "https://github.com/tongueroo/cfn-status".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.1.6".freeze
  s.summary = "CloudFormation status library".freeze
