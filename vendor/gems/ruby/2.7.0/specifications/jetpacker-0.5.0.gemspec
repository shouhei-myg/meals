# -*- encoding: utf-8 -*-
# stub: jetpacker 0.5.0 ruby lib

Gem::Specification.new do |s|
  s.name = "jetpacker".freeze
  s.version = "0.5.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "changelog_uri" => "https://github.com/tongueroo/jetpacker/blob/v0.5.0/CHANGELOG.md", "source_code_uri" => "https://github.com/tongueroo/jetpacker/tree/v0.5.0" } if s.respond_to? :metadata=
  s.require_paths = ["lib".freeze]
  s.authors = ["Tung Nguyen".freeze]
  s.date = "2021-01-05"
  s.email = ["tongueroo@gmail.com".freeze]
  s.homepage = "https://github.com/tongueroo/jetpacker".freeze
  s.licenses = ["MIT".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.4.0".freeze)
  s.rubygems_version = "3.1.6".freeze
  s.summary = "Use webpack to manage app-like JavaScript modules in Jets".freeze
